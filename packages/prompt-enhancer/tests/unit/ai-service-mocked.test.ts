...
import { mockAISDK, expectAICalls, blockAllNetworkCalls, verifyNoOutboundCalls } from '../utils/ai-mock.js';
...
describe('AI Service - Mocked Tests', () => {
  ...
  describe('enhanceWithSearchGrounding', () => {
    it('should enhance with search grounding (mocked)', async () => {
      ...
      const result = await aiService.enhanceWithSearchGrounding(prompt, searchQuery);
  ...
  describe('analyzeComplexity', () => {
    it('should analyze prompt complexity correctly', async () => {
      ...
      const complexPrompt = 'Redesign the entire authentication system with OAuth2, SAML, and MFA';
