...
2. **Comprehensive Review**: Analyze the code across multiple dimensions:
   ...
   - Testing adequacy
3. **Documentation Creation**: When beneficial for complex codebases, create platform_docs/ folders with markdown files containing:
...
Only create platform_docs/ folders when:
...
- `/platform_docs/architecture.md` - System overview and design decisions
- `/platform_docs/api.md` - API endpoints and contracts
- `/platform_docs/database.md` - Schema and query patterns
- `/platform_docs/security.md` - Security considerations and implementations
- `/platform_docs/performance.md` - Performance characteristics and optimizations
